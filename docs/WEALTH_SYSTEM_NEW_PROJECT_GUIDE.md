...
## 启动前置
- 已完成基座同频：`python3 tools/ops_init.py -> python3 tools/ops_learn.py MODEL_SYNC=1 PLAN_MODE=strong -log -> python3 tools/ops_ready.py`
...
- 使用基座流程：
  ...
  - `bash tools/ops_legacy.sh execute TARGET=do CONFIRM_CONTRACT=1`
