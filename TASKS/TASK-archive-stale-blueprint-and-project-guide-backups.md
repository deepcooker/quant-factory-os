# TASK: archive stale blueprint and project guide backups

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-archive-stale-blueprint-and-project-guide-backups
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P2

## Goal
把已无正式主线价值的备份文档移到 chatlogs。
...
## Acceptance
- [ ] stale backup docs moved to chatlogs
- [ ] formal docs no longer reference moved paths
