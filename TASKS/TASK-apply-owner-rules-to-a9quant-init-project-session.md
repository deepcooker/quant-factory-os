# TASK: apply owner rules to a9quant init-project session

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-apply-owner-rules-to-a9quant-init-project-session
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P1

## Goal
Update /root/a9quant-strategy init_project_session with owner-provided collaboration, lifecycle, workflow, and delivery rules without writing owner docs.

## Scope
- `learn/a9quant-strategy_init_project_update_payload_owner_rules.json`
