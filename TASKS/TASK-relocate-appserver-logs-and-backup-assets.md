# TASK: relocate appserver logs and backup assets

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-relocate-appserver-logs-and-backup-assets
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P2

## Goal
把 test_app 日志收进 appserver_log，tools/backup 移到 chatlogs，并删除 log.txt。
...
## Acceptance
- [ ] test_app logs moved under appserver_log
- [ ] tools/backup moved under chatlogs
- [ ] log.txt removed
