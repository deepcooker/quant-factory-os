# TASK: prepare a9quant init-project update payload

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-prepare-a9quant-init-project-update-payload
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P1

## Goal
Read the current must_read_next files from /root/a9quant-strategy init_project_session and draft the next --update-init-project payload for the same session.

## Scope
- `learn/a9quant-strategy_init_project_update_payload.json`
