# TASK: fix-foundation-project-config-template-git-remote

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-fix-foundation-project-config-template-git-remote
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P1

## Goal
Align foundation project_config.template.json git remote/login with actual quant-factory-os repo values.
