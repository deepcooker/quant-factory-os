...
Generated At (UTC): 2026-03-02T08:28:45.579324+00:00
Mode: discussion-only (not execution evidence)
Open Queue Items: 0

## Direction Options
- id=`ready-exit-resolution` | priority=`P0` | score=1586
...
- id=`ready-strong-brief` | priority=`P1` | score=942
...
- id=`discussion-execution-split` | priority=`P2` | score=812
...
- id=`post-exec-drift-review` | priority=`P3` | score=636
...
- id=`council-contract` | priority=`P4` | score=270
