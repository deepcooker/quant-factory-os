# TASK: align remaining a9quant init-project rules with foundation

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-align-remaining-a9quant-init-project-rules-with-foundation
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P1

## Goal
Apply the owner rule that the remaining init-project workflow/session/task conventions should match the foundation project, and continue the same /root/a9quant-strategy init_project_session without writing owner docs.

## Scope
- `learn/a9quant-strategy_init_project_update_payload_foundation_parity.json`
