# TASK: migrate minimal tools into a9quant strategy

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-migrate-minimal-tools-into-a9quant-strategy
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P1

## Goal
Copy only the minimal foundation tools required to run the mainline into /root/a9quant-strategy, while avoiding files the target project does not need or did not originally have.
...
- `learn/a9quant_strategy_tool_migration_plan.md`
