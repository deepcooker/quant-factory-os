# TASK: run real a9quant strategy init-project xhigh

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-run-real-a9quant-strategy-init-project-xhigh
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P1

## Goal
Use the generic init-project xhigh flow against /root/a9quant-strategy, persist init_project_session state, and validate the manual continuation contract on the real target project.
