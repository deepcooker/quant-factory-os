# TASK: validate init-project reasoning on real-material asset

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-validate-init-project-reasoning-on-real-material-asset
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P1

## Goal
Validate phase1 answered_questions stability on non-fixture real-project-derived materials that already live inside this repository.
...
## Acceptance
- [ ] A non-fixture in-repo material set is exercised through init-project phase1
