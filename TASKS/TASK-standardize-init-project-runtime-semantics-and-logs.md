# TASK: standardize-init-project-runtime-semantics-and-logs

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-standardize-init-project-runtime-semantics-and-logs
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P1

## Goal
Make init-project product-safe: repeatable click semantics, standardized logs, and err_code only for true errors; mirror changes into a9quant-strategy minimal tools.

## Scope
- `tools/appserverclient.py docs/WORKFLOW.md docs/FILE_INDEX.md AGENTS.md and mirrored target tools/appserverclient.py`
