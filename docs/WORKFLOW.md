...
前置门禁：
- `tools/project_config.json -> bootstrap_state.is_inited` 必须为 `Y`
- 只要不是 `Y`，都说明项目尚未完成首轮接入，必须先走 `python3 tools/appserverclient.py --init-project`
