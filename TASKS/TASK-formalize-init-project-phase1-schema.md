# TASK: Formalize init-project phase1 schema

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-formalize-init-project-phase1-schema
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P1

## Goal
Define the minimal phase1 JSON schema for init-project question-completion output and align prompt/docs
