...
- [>] TODO Title: 强化 tools/task.sh --plan：Queue 为空时生成 Suggested tasks（可复制入队）  Picked: run-2026-02-25-tools-task-sh-plan-queue-suggested-tasks 2026-02-25T13:15:27+0800
