# TASK: rehydrate minimal a9quant tools after cleanup

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-rehydrate-minimal-a9quant-tools-after-cleanup
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P1

## Goal
Restore the minimal toolset and project_config needed for /root/a9quant-strategy to run init.py again after manual cleanup.
