...
Generated At (UTC): 2026-03-03T04:31:33.991950+00:00
Mode: discussion-only (not execution evidence)
Open Queue Items: 0

## Direction Options
- id=`ready-exit-resolution` | priority=`P0` | score=1680
...
- id=`ready-strong-brief` | priority=`P1` | score=994
...
- id=`discussion-execution-split` | priority=`P2` | score=850
...
- id=`post-exec-drift-review` | priority=`P3` | score=632
...
- id=`council-contract` | priority=`P4` | score=274
