# TASK: docs stale flow noise cleanup

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-docs-stale-flow-noise-cleanup
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P2

## Goal
清理 docs 下仍会误导当前正式主线的旧流程表述。
...
## Acceptance
- [ ] formal docs no longer present deprecated flow as active workflow
