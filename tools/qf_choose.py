...
def main(argv: list[str]) -> int:
    ...
    contract = {
        ...
        "next_command": f"tools/qf council RUN_ID={obj.get('run_id') or ''}",
    }
    out = {
        "project_id": project_id,
        "run_id": obj.get("run_id"),
    ...
    lines.extend(["", "## Next Command", f"- `tools/qf council RUN_ID={obj.get('run_id')}`", ""])
    ...
    append_execution_event(
        ...
        "orient_chosen",
        "ok",
        f"tools/qf choose RUN_ID={run_id} OPTION={option}",
