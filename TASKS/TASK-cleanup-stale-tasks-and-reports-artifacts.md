# TASK: cleanup stale tasks and reports artifacts

RUN_ID: run-2026-03-11-vnext-release-baseline
TASK_ID: task-cleanup-stale-tasks-and-reports-artifacts
PROJECT_ID: quant-factory-os
STATUS: active
PRIORITY: P2

## Goal
清理 TASKS/ 和 reports/ 下无正式主线价值的残留，并移除废弃的 QUEUE.md。
...
## Acceptance
- [ ] QUEUE.md removed if no longer needed
- [ ] stale task/report artifacts removed
